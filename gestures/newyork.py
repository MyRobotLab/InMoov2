def newyork():
  ...
  #i01.startedGesture()
  #start the song
  i01_audioPlayer.playFile('resource/InMoov2/system/sounds/newYorkSong.mp3', False)
  ...
  sleep(1.5)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("Start spreading the news spreading the news")
  i01.setHeadSpeed(43.0,43.0)
  ...
  i01.moveTorso(90,90,90)
  sleep(3)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("I am leaving today")
  i01.moveHead(160,68)
  i01.moveArm("left",5,86,30,10)
  i01.moveArm("right",86,140,83,80)
  i01.moveHand("left",99,140,173,167,130,26)
  ...
  i01.moveTorso(90,90,90)
  sleep(3)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("I want to be a part of it to be a part of it")
  i01.moveHead(138,86)
  ...
  i01.moveTorso(90,90,90)
  sleep(1.5)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("New York, New York, New York")
  sleep(1)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("New York, New York")
  i01.moveHead(138,86)
  i01.moveArm("left",80,112,52,34)
  i01.moveArm("right",80,122,59,54)
  i01.moveHand("left",105,76,71,98,76,90)
  ...
  i01.moveTorso(90,90,90)
  sleep(2)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("If I can make it there it there")
  i01.moveHead(160,86)
  ...
  i01.moveTorso(90,90,90)
  sleep(1.5)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("I'll make it anywhere, it anywhere")
  sleep(1)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("I'll make it anywhere")
  i01.moveHead(160,86)
  i01.moveArm("left",80,128,71,62)
  i01.moveArm("right",80,132,69,80)
  i01.moveHand("left",45,40,30,25,35,90)
  ...
  i01.moveTorso(90,90,90)
  sleep(2)
  if runtime.isStarted('i01.mouthControl'):i01_mouthControl.moveMouthServo("It's up to you")
  i01.moveHead(160,86)
