...
# i01_eyeRightLR.PIN(3)
# i01_eyeRightUD.PIN(4)
# i01_eyeLeftLR.PIN(5)
# i01_eyeLeftUD.PIN(6)
...
###BOTH EYES###
def eyesC():
  if runtime.isStarted('i01.eyeLeftUD') and runtime.isStarted('eyeLeftLR') and runtime.isStarted('i01.eyeRightUD') and runtime.isStarted('i01.eyeRightLR'):
    i01_eyeLeftUD.moveTo(90)
    i01_eyeLeftLR.moveTo(90)
    i01_eyeRightUD.moveTo(90)
    i01_eyeRightLR.moveTo(90)
    sleep(0.01)

def eyesU():
  if runtime.isStarted('i01.eyeLeftUD') and runtime.isStarted('eyeLeftLR') and runtime.isStarted('i01.eyeRightUD') and runtime.isStarted('i01.eyeRightLR'):
    i01_eyeLeftUD.moveTo(180)
    i01_eyeLeftLR.moveTo(90)
    i01_eyeRightUD.moveTo(180)
    i01_eyeRightLR.moveTo(90)
    sleep(0.01)
   
def eyesD():
  if runtime.isStarted('i01.eyeLeftUD') and runtime.isStarted('eyeLeftLR') and runtime.isStarted('i01.eyeRightUD') and runtime.isStarted('i01.eyeRightLR'):
    i01_eyeLeftUD.moveTo(0)
    i01_eyeLeftLR.moveTo(90)
    i01_eyeRightUD.moveTo(0)
    i01_eyeRightLR.moveTo(90)
    sleep(0.01)
...
def eyesL():
  if runtime.isStarted('i01.eyeLeftUD') and runtime.isStarted('eyeLeftLR') and runtime.isStarted('i01.eyeRightUD') and runtime.isStarted('i01.eyeRightLR'):
    i01_eyeLeftUD.moveTo(90)
    i01_eyeLeftLR.moveTo(180)
    i01_eyeRightUD.moveTo(90)
    i01_eyeRightLR.moveTo(180)
    sleep(0.01)
  
def eyesR():
  if runtime.isStarted('i01.eyeLeftUD') and runtime.isStarted('eyeLeftLR') and runtime.isStarted('i01.eyeRightUD') and runtime.isStarted('i01.eyeRightLR'):
    i01_eyeLeftUD.moveTo(90)
    i01_eyeLeftLR.moveTo(0)
    i01_eyeRightUD.moveTo(90)
    i01_eyeRightLR.moveTo(0)
    sleep(0.01)
...
###LEFT EYE ONLY###
def eyeLeftC():
  if runtime.isStarted('i01.eyeLeftUD') and runtime.isStarted('eyeLeftLR'): 
    i01_eyeLeftUD.moveTo(90)
    i01_eyeLeftLR.moveTo(90)
    sleep(0.01)
...
###RIGHT EYE ONLY###
def eyeRightC():
  if runtime.isStarted('i01.eyeRightUD') and runtime.isStarted('i01.eyeRightLR'):
    i01_eyeRightUD.moveTo(90)
    i01_eyeRightLR.moveTo(90)
    sleep(0.01)
