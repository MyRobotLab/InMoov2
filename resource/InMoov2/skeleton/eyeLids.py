...
if (isEyeLidsActivated and (ScriptType=="RightSide" or ScriptType=="LeftSide" or ScriptType=="Full")):
  if LeftPortIsConnected or RightPortIsConnected:
    ...
    eyelids.eyelidleft.setSpeed(ThisSkeletonPartConfig.getint('MAX_SPEED', 'eyelidleft'))
    eyelids.eyelidright.setSpeed(ThisSkeletonPartConfig.getint('MAX_SPEED', 'eyelidright'))
