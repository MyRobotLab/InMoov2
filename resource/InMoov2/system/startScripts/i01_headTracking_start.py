...
i01_headPid.setControllerDirection("i01.head.rothead", 0)
#set the range of the "correction"
i01_headPid.setOutputRange("i01.head.rothead", -5, 5)

i01_headPid.setPid("i01.head.neck", 0.035, 0.01, 0.0)
i01_headPid.setMode("i01.head.neck", 1)
i01_headPid.setControllerDirection("i01.head.neck", 0)
#set the range of the "correction"
i01_headPid.setOutputRange("i01.head.neck", -5, 5)
...
i01_headTracking.attachPid("i01.headPid")
