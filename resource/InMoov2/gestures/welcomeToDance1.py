...
def danceYes():
  ...
  if x == 1:
    ...
    sleep(1)
    i01_audioPlayer.playFile(RuningFolder+'/system/sounds/Cant Get Enough CutVersion.mp3')  
    sleep(45)
  ...
  if x == 2:
    ...
    i01.moveHead(20,90,30)
    MoveHeadTimer.startClock()
    i01_audioPlayer.playFile(RuningFolder+'/system/sounds/Just The Way CutVersion.mp3')
    sleep(45)
    MoveHeadTimer.stopClock()
    ear.setAutoListen(setAutoListen)
  if x == 3:
    ...
    i01_audioPlayer.playFile(RuningFolder+'/system/sounds/Ah le petit vin blanc.mp3')
    sleep(45)
    ear.setAutoListen(setAutoListen)  
