def muscle():
  i01.startedGesture()
  i01.setHandVelocity("left", 100.0, 100.0, 100.0, 100.0, 100.0, 100.0)
  i01.setHandVelocity("right", 100.0, 100.0, 100.0, 100.0, 100.0, 100.0)
  i01.setArmVelocity("right", 31.0, 43.0, 59, 43.0)
  i01.setArmVelocity("left", 31.0, 43.0, 59, 43.0)
  i01.setHeadVelocity(22.0, 22.0)
  i01.setTorsoVelocity(31.0, 13.0, 100.0)
  i01.moveHead(90,129)
  ...
  sleep(4)
  i01.speakBlocking("Looks good, doesn't it")
  #i01.speakBlocking(u"Выглядит хорошо, не так ли?")
  sleep(2)
  i01.setHandVelocity("left", 100.0, 100.0, 100.0, 100.0, 100.0, 100.0)
  i01.setHandVelocity("right", 100.0, 100.0, 100.0, 100.0, 100.0, 100.0)
  i01.setArmVelocity("right", 100.0, 100.0, 100.0, 100.0)
  i01.setArmVelocity("left", 100.0, 100.0, 100.0, 100.0)
  ...
  sleep(3)
  i01.speakBlocking("not bad either, don't you think")
  #i01.speakBlocking(u"Неплохо, не так ли?")
  sleep(4)
  i01.finishedGesture()
  relax()
  sleep(1)
